...
async function main() {
    ...
    const start: LatLon = { lat: 40.73124319217295, lon: -73.99711744955137 }
    const end: LatLon = { lat: 40.803228812387765, lon: -73.9446265187239 }
    const center: LatLon = { lat: (start.lat + end.lat) / 2, lon: (start.lon + end.lon) / 2 } // example downtown coords
